...
* To properly sim Desert Fairy, you should activate both components in the strategy skill section: "Desert (debuff)" and "Desert (negation". The former applies the debuff to you and the enemy, the latter negates the effect on your echelon.
